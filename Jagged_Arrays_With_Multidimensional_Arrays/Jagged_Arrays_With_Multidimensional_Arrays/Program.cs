...
namespace Jagged_Arrays_With_Multidimensional_Arrays
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //sAn example of GetLength is GetLength(0), which returns the number of elements in the first dimension of the Array.
        }
    }
}
